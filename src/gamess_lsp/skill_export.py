...
SKILL_SPEC_JSON = (
    '{"schema":"scientific-lsp-skill/v1","name":"gamess","software":"gamess","dis'
    'play_name":"GAMESS","description":"GAMESS input preflight for generated .inp'
    ' job files.","package":{"name":"gamess-lsp","install":"pip install gamess-ls'
    'p"},"entrypoints":{"server":"gamess-lsp","tool":"gamess-lsp-tool"},"file_pat'
    'terns":["*.inp"],"operations":["capabilities","check","context","complete","'
    'hover","symbols","fix"],"diagnostic_contract":"DiagnosticEnvelope/v1","block'
    'ing_policy":{"mode":"warning-only","description":"Use --fail-on-blocking whe'
    'n generated inputs must be launch-ready."},"source_provenance":[{"kind":"off'
    'icial_docs","label":"GAMESS input documentation","url":"https://www.msg.chem'
    '.iastate.edu/gamess/documentation.html"}]}'
)
...
SKILL_MD_LINES = [
    ...
    '',
    (
        'Use this skill when preparing, repairing, or reviewing GAMESS input files be'
    ...
    '',
    (
        'This installs the `gamess-lsp` language server and the `gamess-lsp-tool` age'
        'nt CLI from the `gamess-lsp` Python package.'
    ),
    '',
    ...
    (
        'gamess-lsp-tool context <input-file-or-dir> --line 0 --character 0 --format '
        'json'
    ),
    (
        'gamess-lsp-tool hover <input-file-or-dir> --line 0 --character 0 --format js'
        'on'
    ),
    (
        'gamess-lsp-tool complete <input-file-or-dir> --line 0 --character 0 --format'
        ' json'
    ),
