"""Release contract for the GAMESS-LSP 0.1.1 publication path."""
...
def test_release_version_is_consistent_across_all_manifests() -> None:
    ...
    init_text = (REPO_ROOT / "src/gamess_lsp/__init__.py").read_text(encoding="utf-8")
